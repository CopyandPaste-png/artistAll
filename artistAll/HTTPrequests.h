...
static curl_slist* createList(std::string token) {
...
static void initCURLWriting(CURL* curl,std::string website, std::string POSTdata,std::string& readBuffer,curl_slist* list) {
...
*/
static std::string performSimpleCURLGET(std::string website) {
...
static std::string performCURLGET(std::string website, std::string token) {
    ...
    //Used for headers
    struct curl_slist* list = createList(token);
...
static std::string performCURLPOST(std::string website, std::string POSTdata, std::string token) {
    ...
    if (curl) {
        initCURLWriting(curl, website, POSTdata, readBuffer, list);
